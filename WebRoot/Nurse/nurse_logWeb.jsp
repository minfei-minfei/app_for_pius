...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header">
        <a href="#" class="navbar-brand glyphicon glyphicon-chevron-left">护工登录</a>
    </div>
</nav>
<form id="user-login-form" class="container" role="form" action="nurse_login.jsp" method="post">
    <ul class="list-group">
        ...
        <li class="list-group-item">
            ...
            <input type="text" class="form-control" name="nursePsd" value="请输入密码"
                   autocomplete="off"/>
        </li>
    </ul>
    <div id="login-help">
        <a href="nurse_regisG.jsp" class="pull-left"><span class="glyphicon glyphicon-edit">还没注册</span></a>
...
<div class="modal fade" id="forgetModal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="user-forgerPsd-form" role="form" action="nurse_login.html">
