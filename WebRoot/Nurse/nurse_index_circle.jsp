    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <div id="circle-nav" class="navbar-title">
                <ul class="pagination">
                    <li class="active"><a href="nurse_index_circle.html">文章</a></li>
                    <li><a href="nurse_index_topic.jsp">话题</a></li>
                </ul>
            </div>
...
<ul id="filter" class="nav nav-tabs">
    ...
    <li class="pull-right"><a href="nurse_index_circle.jsp" class="glyphicon glyphicon-refresh"></a>
</ul>
...
<%while(rs.next()){ %>
    ...
    <div onClick="self.location='nurse_articleDetail.jsp?pram_atcTit=<%=rs.getString("atcTit")%>'">
