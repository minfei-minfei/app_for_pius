...
<ul id="filter" class="nav nav-tabs">
    ...
    <li><a href="user_index_nurse_ser.jsp">服务级别</a></li>
    <li id="filter-icon" class="active"><a href="javascript:;" data-toggle="collapse" data-target="#multiple-filter"
...
<%  while(rs.next()){
	session.setAttribute("pram_nurseName",rs.getString("nurseName_"));
%>
