    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <div id="circle-nav" class="navbar-title">
                <ul class="pagination">
                    <li><a href="user_index_circle.jsp">文章</a></li>
                    <li class="active"><a href="user_index_topic.jsp">话题</a></li>
                </ul>
            </div>
...
<ul id="filter" class="nav nav-tabs">
    ...
    <li class="pull-right"><a href="user_index_topic.jsp" class="glyphicon glyphicon-refresh"></a>
</ul>
<%while(rs.next()){ %>
<div class="topic">
    <div class="container">
