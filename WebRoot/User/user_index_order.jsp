...
String seleStr="SELECT * FROM userorder WHERE username ='"+s_username+"'";
...
<div class="media">
    <div class="container">
        <a class="media-left" href="javasctipt:;">
            <img class="media-object" src="../img/nurse_portrait_default.png"alt="">
        </a>
        <div class="media-body" onClick="self.location='user_check.jsp?param_order=<%=rs.getString("ordernumber")%>'">
            <h4 class="media-heading"><%=rs.getString("nursename")%>
                <span class="pull-right small">待支付</span>
            </h4>
...
<ul id="bottom-nav" class="pager">
    ...
    <li class="active"><a href="user_index_order.jsp"><span class="glyphicon glyphicon-list-alt"></span>订单</a></li>
